            ...
            <div x-cloak x-show="followup !== null" x-transition.opacity
                ...
                <div class="relative z-[10000] flex max-h-[96dvh] w-full min-w-0 max-w-4xl flex-col overflow-hidden rounded-xl bg-white shadow-2xl sm:max-h-[90vh] sm:rounded-2xl"
                    ...
                    <div class="min-w-0 flex-1 overflow-x-hidden overflow-y-auto bg-white p-4 sm:p-5">
                        <form :action="'/business/leads/' + followup + '/follow-ups'" method="POST" id="followup-form"
                            data-after-save="stay" class="min-w-0 space-y-4" @submit.prevent="
                                (async () => {
                            ...
                            <input type="hidden" name="lead_id" x-bind:value="followupLeadId">
                            ...
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <select name="status" id="followup_status" class="form-input w-full"
                                        x-model.number="followupStatusid" @change="toggleFollowUpDate($event.target)">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="expected_date_time" id="expected_date_time"
                                        class="form-input w-full cursor-pointer bg-white"
                                        placeholder="Select Follow-Up Date" autocomplete="off" readonly
                            ...
                            <div>
                                ...
                                <textarea id="followup_remark" name="remark" rows="4"
                                    class="form-input form-textarea w-full"
                                    placeholder="Notes about the call..."></textarea>
                            </div>

                            {{-- Save buttons --}}
                            <div
                                class="flex flex-col-reverse gap-2 border-t border-slate-200 pt-4 sm:flex-row sm:justify-end">
                                <button type="submit" @click="$el.form.dataset.afterSave = 'stay'"
                                ...
                                <button type="submit" @click="$el.form.dataset.afterSave = 'next'"
